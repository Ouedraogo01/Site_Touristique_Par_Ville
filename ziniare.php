...
<head>
    ...
    <link rel="stylesheet" href="ziniare.css">
...
<body>
    ...
    <div id="carouselExempleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="ziniare/1.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Ziniaré.
                </div>
            </div>
            <div class="carousel-item">
                <img src="ziniare/2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Ziniaré.
                    </p>
            ...
            <div class="carousel-item">
                <img src="ziniare/4.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Ziniaré.
                    </p>
            ...
            <div class="carousel-item">
                <img src="ziniare/5.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Ziniaré.
                    </p>
            ...
            <div class="carousel-item">
                <img src="ziniare/6.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Ziniaré.
                    </p>
    ...
    <section class="section1">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 pt-5">
            <?php
            $im = $banfora->query("SELECT * FROM lieu WHERE id_ville=7");
            while ($donnees = $im->fetch()) {

                ?>
                <div class="col-lg-4">
                    <div class="card m-2">
                        <img src="ziniare/<?php echo $donnees["photo"] ?>" class="card-img-top" style="height: 300px"
                            alt="...">
                        <div class="card-body">
    ...
    <section class="section2">
        <div class="haut">
            <h1 class="titre m-5 text-center " style="color: black">Ziniaré, merci de nous choisir pour votre visite
            </h1>
        </div>

        <div class="destination m-5 mb-5">
            <?php
            $tex = $banfora->query("SELECT * FROM text WHERE id_ville=7");
            ...
            <div id="mainCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" style="height: 400px" style=" width: 300px">
                    <?php
                    $pho = $banfora->query("SELECT * FROM carou WHERE id_ville=7");
                    while ($donnees = $pho->fetch()) {


                        ?>
                        <div class="carousel-item active">
                            <img src="ziniare/<?php echo $donnees["photos"] ?>" class="d-block w-100" alt="...">
                        </div>
                    <?php } ?>
                </div>
