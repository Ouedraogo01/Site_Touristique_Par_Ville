...
<body>
    ...
    <div id="carouselExempleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="bobo/1.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Bobo-Dioulasso.
                </div>
            </div>
            <div class="carousel-item">
                <img src="bobo/2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Bobo-Dioulasso.
                    </p>
            ...
            <div class="carousel-item">
                <img src="bobo/4.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Bobo-Dioulasso.
                    </p>
            ...
            <div class="carousel-item">
                <img src="bobo/5.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Bobo-Dioulasso.
                    </p>
            ...
            <div class="carousel-item">
                <img src="bobo/3.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <p class="animated fadeInUp d-done d-md-block">
                        BURKINA FASO: Bienvenue à Bobo-Dioulasso.
                    </p>
    ...
    <section class="section1">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 pt-5">
            <?php
            $im = $bobo->query("SELECT * FROM lieu WHERE id_ville=6");
            while ($donnees = $im->fetch()) {

                ?>
                <div class="col-lg-4">
                    <div class="card m-2">
                        <img src="bobo/<?php echo $donnees["photo"] ?>" class="card-img-top" style="height: 300px"
                            alt="...">
                        <div class="card-body">
    ...
    <section class="section 2">
        <div class="haut">
            <h1 class="titre m-5 text-center " style="color: black">Merci de choisir Bobo-Dioulasso pour vos congés et
                vacances
            </h1>
        </div>
        ...
        <div class="destination m-5 mb-5">
            <?php
            $tex = $bobo->query("SELECT * FROM text WHERE id_ville=6");
            ...
            <div id="mainCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" style="height: 400px" style=" width: 300px">
                    <?php
                    $pho = $bobo->query("SELECT * FROM carou WHERE id_ville=6");
                    while ($donnees = $pho->fetch()) {


                        ?>
                        <div class="carousel-item active">
                            <img src="bobo/<?php echo $donnees["photos"] ?>" class="d-block w-100" alt="...">
                        </div>
                    <?php } ?>
                </div>
    ...
    <section class="section3 center">
        ...
        <!-- <div class="connaitre">
            <div class="about text-center mt-3">
                <h2>Apprende d'avantage sur banfora</h2>
            </div>
        ...
        <div class="sponsors" style="text-align: center">
            <?php
            $spo = $bobo->query("SELECT * FROM sponsors WHERE id_ville=6");
